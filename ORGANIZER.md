...
агента; диагностика и починка `~/.ssh/config` описаны в `CLAUDE.md` (раздел
«Git и общая копилка»). Установщики стоит привести к 443 заранее, чтобы push
с нуля шёл без заминок.
