...
Открытый командный риск: проверочная заявка рискованного клиента идёт со сроком
`term_months = 6`. На 2026-05-25 retail возвращает решение клиенту, но слабая
заявка может не сохраниться в backend и получить `storage = "backend_not_ready"`.
Для устойчивого сквозного сценария backend должен принимать срок 6 месяцев либо
retail и backend должны согласовать единый список допустимых сроков.
