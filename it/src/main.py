...
(имена эндпоинтов, форматы запросов/ответов, поля JSON, как звать LLM-шлюз).
Бизнес-логику отсюда не извлекай: SLA, политики безопасности, приоритеты платформы
получай через INBOX/to_it.md или у своего пользователя. Подробнее — см. it/NEIGHBOR_AGENTS.md.
"""
