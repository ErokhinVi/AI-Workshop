...
извлекай: формулы скоринга, признаки, риск-политики, пороги отсечения — это
содержимое модели и политик Risk, оно приходит через INBOX/to_risk.md или у
своего пользователя. Подробнее — см. risk/NEIGHBOR_AGENTS.md.
"""
